...
param(
 ...
 [string]
 $templateFilePath = "VNET-template.json",
...
if(!$resourceGroup)
{
    ...
    New-AzureRmResourceGroup -Name $resourceGroupName -Location $resourceGroupLocation -Tag @{ Owner="Thiago Di Giorgio"; Email="thiago.digiorgio@Version1.com"; Project="GRS Test" }
}
else{
